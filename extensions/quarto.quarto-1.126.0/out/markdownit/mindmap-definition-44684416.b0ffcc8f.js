import { c as Ca, g as yp, y as mp, a as sn, l as qr, s as nn, b as bp, v as Ep, w as wp } from "./index.8ad9f308.js";
import { i as xp } from "./is_dark.18767f3d.js";
var Vu = { exports: {} };
(function(de, fe) {
  (function(Q, he) {
    de.exports = he();
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
    ...
    }, vt = "(?:[-+]?(?:(?:\\d+|\\d*\\.\\d+)(?:[Ee][+-]?\\d+)?))", vr = "rgb[a]?\\((" + vt + "[%]?)\\s*,\\s*(" + vt + "[%]?)\\s*,\\s*(" + vt + "[%]?)(?:\\s*,\\s*(" + vt + "))?\\)", qt = "rgb[a]?\\((?:" + vt + "[%]?)\\s*,\\s*(?:" + vt + "[%]?)\\s*,\\s*(?:" + vt + "[%]?)(?:\\s*,\\s*(?:" + vt + "))?\\)", un = "hsl[a]?\\((" + vt + ")\\s*,\\s*(" + vt + "[%])\\s*,\\s*(" + vt + "[%])(?:\\s*,\\s*(" + vt + "))?\\)", Kr = "hsl[a]?\\((?:" + vt + ")\\s*,\\s*(?:" + vt + "[%])\\s*,\\s*(?:" + vt + "[%])(?:\\s*,\\s*(?:" + vt + "))?\\)", Da = "\\#[0-9a-fA-F]{3}", jt = "\\#[0-9a-fA-F]{6}", Ji = function(e, r) {
    ...
    var pl = gl, yl = ln.Symbol, Zr = yl, ts = Object.prototype, ml = ts.hasOwnProperty, bl = ts.toString, La = Zr ? Zr.toStringTag : void 0;
    function El(t) {
    ...
    var Dl = Cl, Sl = "[object Null]", Ll = "[object Undefined]", rs = Zr ? Zr.toStringTag : void 0;
    function Al(t) {
      return t == null ? t === void 0 ? Ll : Sl : rs && rs in Object(t) ? wl(t) : Dl(t);
    }
    var as = Al;
    function Ol(t) {
    ...
    function Il(t) {
      return typeof t == "symbol" || Nl(t) && as(t) == Ml;
    }
    var Aa = Il, ns = 0 / 0, Rl = /^[-+]0x[0-9a-f]+$/i, kl = /^0b[01]+$/i, Pl = /^0o[0-7]+$/i, Bl = parseInt;
    function Fl(t) {
      if (typeof t == "number")
        return t;
      if (Aa(t))
      ...
      t = pl(t);
      var r = kl.test(t);
      return r || Pl.test(t) ? Bl(t.slice(2), r ? 2 : 8) : Rl.test(t) ? ns : +t;
    }
    var is = Fl, zl = "Expected a function", Gl = Math.max, $l = Math.min;
    function Vl(t, e, r) {
      var a, n, i, s, o, l, u = 0, f = !1, h = !1, c = !0;
      if (typeof t != "function")
        throw new TypeError(zl);
      e = is(e) || 0, Rr(r) && (f = !!r.leading, h = "maxWait" in r, i = h ? Gl(is(r.maxWait) || 0, e) : i, c = "trailing" in r ? !!r.trailing : c);
      function v(O) {
        var x = a, I = n;
    ...
    var fn = Vl, ri = D ? D.performance : null, ss = ri && ri.now ? function() {
      return ri.now();
    } : function() {
      return Date.now();
    }, _l = function() {
      ...
      return r;
    }, fs = !0, Xl = console.warn != null, ql = console.trace != null, ai = Number.MAX_SAFE_INTEGER || 9007199254740991, hs = function() {
      return !0;
    }, vn = function() {
      return !1;
    }, cs = function() {
      ...
      !vs() || (Xl ? console.warn(e) : (console.log(e), ql && console.trace()));
    }, Wl = function(e) {
      return Ue({}, e);
    }, or = function(e) {
      ...
      function t(e) {
        if (he(this, t), this._obj = /* @__PURE__ */ Object.create(null), this.size = 0, e != null) {
          var r;
      ...
      bellmanFord: function(e) {
        ...
        if (C)
          for (var oe = [], ge = 0; ge < p; ge++) {
            var se = h[ge], ve = se.source(), we = se.target(), Te = o(se), Ee = m(ve).dist, ye = m(we).dist;
      ...
      betweennessCentrality: function(e) {
        ...
        for (var g = function(b) {
          ...
          for (var ge = {}, se = 0; se < o.length; se++)
            ge[o[se].id()] = 0;
          for (; M.length > 0; ) {
            for (var ve = M.pop(), we = 0; we < O[ve].length; we++) {
              var Te = O[ve][we];
    ...
    var Vf = Lt({
      ...
      euclidean: function(e, r, a) {
        return e >= 2 ? za(e, r, a, 0, Is, eh) : za(e, r, a, 0, Ms);
      },
    ...
    var rh = Lt({
      ...
      i.testMode ? typeof i.testCentroids == "number" ? (i.testCentroids, l = pi(a, i.k, i.attributes)) : Q(i.testCentroids) === "object" ? l = i.testCentroids : l = pi(a, i.k, i.attributes) : l = pi(a, i.k, i.attributes);
      ...
      i.testMode ? typeof i.testCentroids == "number" || (Q(i.testCentroids) === "object" ? o = i.testCentroids : o = Ps(a, i.k)) : o = Ps(a, i.k);
      ...
      for (C = 0; C < n.maxIterations; C++) {
        ...
        for (var se = 0, ve = 0; ve < o; ve++) {
          ...
          x[C % n.minIterations * o + ve] = we, se += we;
        }
    ...
    [Ia, af, nf, of, lf, hf, df, Gf, ra, aa, di, Jf, hh, yh, Ch, Sh, Lh, Ah].forEach(function(t) {
      Ue(_s, t);
    });
    /*!
    ...
    */
    ...
    var Vh = $h, _h = ln["__core-js_shared__"], mi = _h, Zs = function() {
    ...
    var bi = sc, oc = bi(Object, "create"), Ga = oc;
    function uc() {
    ...
    var js = ua, ev = "Expected a function";
    function Ei(t, e) {
    ...
    var to = uv, lv = 1 / 0, ro = Zr ? Zr.prototype : void 0, ao = ro ? ro.toString : void 0;
    function no(t) {
      if (typeof t == "string")
        return t;
      if (Cn(t))
    ...
    var io = hv;
    function cv(t, e) {
      return Cn(t) ? t : Ph(t, e) ? [t] : eo(io(t));
    }
    var so = cv, vv = 1 / 0;
    function dv(t) {
    ...
    function Cv(t, e, r) {
      var a = t[e];
      (!(Tv.call(t, e) && Js(a, r)) || r === void 0 && !(e in t)) && wv(t, e, r);
    }
    var Dv = Cv, Sv = 9007199254740991, Lv = /^(?:0|[1-9]\d*)$/;
    function Av(t, e) {
      var r = typeof t;
      return e = e == null ? Sv : e, !!e && (r == "number" || r != "symbol" && Lv.test(t)) && t > -1 && t % 1 == 0 && t < e;
    }
    var Ov = Av;
    function Nv(t, e, r, a) {
      if (!Rr(t))
    ...
    var Pv = kv;
    function Bv(t) {
      return Cn(t) ? to(t, wi) : Aa(t) ? [t] : Pv(eo(io(t)));
    }
    var Fv = Bv, zv = {
      data: function(e) {
        var r = {
    ...
    var Zt = function(e) {
      ...
      if (!r.cy().headless()) {
        ...
        if (o) {
          ...
          if (ie || oe) {
            var ge = ie ? Va(i.rstyle, "labelAngle", a) : p.pfValue, se = Math.cos(ge), ve = Math.sin(ge), we = (F + R) / 2, Te = (X + z) / 2;
            if (!y) {
              switch (l.value) {
                case "left":
                  we = R;
      ...
      if (b) {
        ...
        bs(He, s), ui(He, p), yn(He, 1), n && (f = s.x1, h = s.x2, c = s.y1, v = s.y2, rr(s, f - I, c - I, h + I, v + I));
        var qe = o.overlayBounds = o.overlayBounds || {};
        bs(qe, s), ui(qe, p), yn(qe, 1);
        var Re = o.labelBounds = o.labelBounds || {};
        Re.all != null ? Cf(Re.all) : Re.all = Ut(), n && r.includeLabels && (r.includeMainLabels && Li(s, e, null), u && (r.includeSourceLabels && Li(s, e, "source"), r.includeTargetLabels && Li(s, e, "target")));
      }
      return s.x1 = Zt(s.x1), s.y1 = Zt(s.y1), s.x2 = Zt(s.x2), s.y2 = Zt(s.y2), s.w = Zt(s.x2 - s.x1), s.h = Zt(s.y2 - s.y1), s.w > 0 && s.h > 0 && b && (ui(s, p), yn(s, 1)), s;
    }, po = function(e) {
    ...
    }, pd = Object.keys(xo).reduce(function(t, e) {
      var r = xo[e], a = gd(e);
      return t[e] = function() {
    ...
    var Co = /^([^.]+)(\.(?:[^.]+))?$/, md = ".*", Do = {
      ...
      context: null
    }, So = Object.keys(Do), bd = {};
    function Mn() {
      for (var t = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : bd, e = arguments.length > 1 ? arguments[1] : void 0, r = 0; r < So.length; r++) {
        var a = So[r];
        this[a] = t[a] || Do[a];
      }
      this.context = e || this.context, this.listeners = [], this.emitting = 0;
    }
    var Or = Mn.prototype, Lo = function(e, r, a, n, i, s, o) {
    ...
    At.takesUpSpace = Bn("takesUpSpace", Oi({
      ok: va
    }));
    ...
    At.interactive = Bn("interactive", Oi({
      ok: Dd,
      parentOk: Sd,
      edgeOkViaNode: va
    ...
    mt.instanceString = function() {
      ...
      return this;
    }, [_s, $v, Ln, Lr, fa, rd, An, yd, Oo, No, xd, Rn, kn, At, Nr, Pt].forEach(function(t) {
      Ue(mt, t);
    });
    var Od = {
      add: function(e) {
    ...
    Bt.apply = function(t) {
      ...
      if (a && a.name.substr(0, 3) === "pie" && ft("The pie style properties are deprecated.  Create charts using background images instead."), e.name === "curve-style" && t.isEdge() && (e.value !== "bezier" && t.isLoop() || e.value === "haystack" && (t.source().isParent() || t.target().isParent())) && (a = e = this.parse(e.name, "bezier", l)), a.delete)
    ...
    _n.parse = function(t, e, r, a) {
      ...
      if (!(!l || a || e.length < 7 || e[1] !== "a")) {
        if (e.length >= 7 && e[0] === "d" && (f = new RegExp(o.data.regex).exec(e))) {
          ...
          if (u.color) {
            var y = d.value, p = g.value, m = y[0] === p[0] && y[1] === p[1] && y[2] === p[2] && (y[3] === p[3] || (y[3] == null || y[3] === 1) && (p[3] == null || p[3] === 1));
            if (m)
              return !1;
          }
          return {
    ...
    }, [Bt, Wa, Ii, lr, Vn, Ri, Nt, _n].forEach(function(t) {
      Ue(zt, t);
    ...
    }), Un.$id = Un.getElementById, [Od, kd, Uo, Ni, Gn, Bd, Mi, $n, Gd, $r, Ka].forEach(function(t) {
      Ue(Un, t);
    });
    var Vd = {
      fit: !0,
    ...
    Ho.prototype.run = function() {
      ...
      if (e.avoidOverlap)
        for (var ie = 0; ie < n.length; ie++) {
          var oe = n[ie], ge = oe.layoutDimensions(e), se = ge.w, ve = ge.h;
          Z = Math.max(Z, se, ve);
        }
    ...
    Vr.projectIntoViewport = function(t, e) {
          ...
          if (d) {
            if (d.pstyle("z-compound-depth").value === x.pstyle("z-compound-depth").value && d.pstyle("z-compound-depth").value === x.pstyle("z-compound-depth").value) {
              for (var C = 0; C < o.length; C++)
                if (o[C].isEdge()) {
                  o[C] = x, d = x, v = I != null ? I : v;
                  break;
                }
            }
          } else
            o.push(x), d = x, v = I != null ? I : v;
      }
      function p(x) {
      ...
      function m(x) {
        ...
        for (var ie = ie || I.source, oe = oe || I.target, ge = n.getArrowWidth(B, F), se = [{
          ...
          var ve = se[Z], we = i.arrowShapes[x.pstyle(ve.name + "-arrow-shape").value], Te = x.pstyle("width").pfValue;
          if (we.roughCollide(t, e, ge, ve.angle, {
            x: ve.x,
            y: ve.y
          }, Te, f) && we.collide(t, e, ge, ve.angle, {
            x: ve.x,
            y: ve.y
          }, Te, f))
            return y(x), !0;
      ...
      function E(x, I) {
        ...
        if (!(!z || !X)) {
          var re = b(C.rscratch, "labelX", I), W = b(C.rscratch, "labelY", I), Z = b(C.rscratch, "labelAngle", I), ie = x.pstyle(F + "text-margin-x").pfValue, oe = x.pstyle(F + "text-margin-y").pfValue, ge = R.x1 - B - ie, se = R.x2 + B - ie, ve = R.y1 - B - oe, we = R.y2 + B - oe;
          if (Z) {
            ...
            }, ae = ye(ge, ve), xe = ye(ge, we), Ce = ye(se, ve), Oe = ye(se, we), Ie = [
              ae.x + ie,
              ae.y + oe,
              Ce.x + ie,
              Ce.y + oe,
    ...
    Vt.findHaystackPoints = function(t) {
      ...
      var W = p === a, Z = W ? z : X, ie = W ? F : B, oe = ms(ie), ge = !1;
      ...
      if (!(!t || t.length === 0)) {
        ...
        for (var E = function(x) {
          ...
          var W = C.srcPos = X.position(), Z = C.tgtPos = z.position(), ie = C.srcW = X.outerWidth(), oe = C.srcH = X.outerHeight(), ge = C.tgtW = z.outerWidth(), se = C.tgtH = z.outerHeight(), ve = C.srcShape = r.nodeShapes[e.getNodeShape(X)], we = C.tgtShape = r.nodeShapes[e.getNodeShape(z)];
          C.dirCounts = {
            north: 0,
            west: 0,
            south: 0,
          ...
          for (var Te = 0; Te < C.eles.length; Te++) {
            ...
            if (!C.calculatedIntersection && X !== z && (C.hasBezier || C.hasUnbundled)) {
              ...
              var Oe = ve.intersectLine(W.x, W.y, ie, oe, Z.x, Z.y, 0), Ie = C.srcIntn = Oe, He = we.intersectLine(Z.x, Z.y, ge, se, W.x, W.y, 0), qe = C.tgtIntn = He, Re = C.intersectionPts = {
                x1: Oe[0],
                x2: He[0],
                y1: Oe[1],
                y2: He[1]
              ...
              C.nodesOverlap = !k(ke) || we.checkPoint(Oe[0], Oe[1], 0, ge, se, Z.x, Z.y) || ve.checkPoint(He[0], He[1], 0, ie, oe, W.x, W.y), C.vectorNormInverse = We, B = {
    ...
    Qa.manualEndptToPx = function(t, e) {
      ...
      if (C === "inside-to-node")
        ...
        var ie = n._private.rscratch, oe = ie.labelWidth, ge = ie.labelHeight, se = ie.labelX, ve = ie.labelY, we = oe / 2, Te = ge / 2, Ee = n.pstyle("text-valign").value;
            ...
            switch (a.edgeType) {
              ...
              case "haystack": {
                for (var X = 0, z, re, W, Z, ie = a.allpts.length, oe = 0; oe + 3 < ie && (v ? (W = {
                  ...
                  ;
                var ge = d - re, se = ge / z;
                se = ka(0, se, 1), e = xf(W, Z, se), c = iu(W, Z);
                break;
              }
            }
...
`), p = 0; p < y.length; p++) {
    ...
    var lu = {};
    [Vr, Xn, Vt, Qa, Fi, fr, su, qn, Wn].forEach(function(t) {
      Ue(lu, t);
    });
    var fu = {};
    ...
    ya.registerBinding = function(t, e, r, a) {
        ...
        if (!!le) {
          ...
          if (t.data.bgActivePosistion && (t.redrawHint("select", !0), t.redraw()), t.hoverData.tapholdCancelled = !0, t.data.bgActivePosistion = void 0, ze && ze.unactivate(), t.hoverData.which === 3) {
            ...
            if (r(Ke, ["mouseup", "tapend", "vmouseup"], N, {
              x: me[0],
              y: me[1]
            }), !t.dragData.didDrag && !t.hoverData.dragged && !t.hoverData.selecting && !t.hoverData.isOverThresholdDrag && (r(ze, ["click", "tap", "vclick"], N, {
              x: me[0],
              y: me[1]
      ...
      var X, z, re, W, Z, ie, oe, ge, se, ve, we, Te, Ee, ye = function(N, le, De, me) {
      ...
      t.registerBinding(window, "touchmove", Ce = function(N) {
        ...
        if (!(!le && !I(N))) {
          ...
          if (le && t.touchData.cxt) {
            N.preventDefault();
            var nr = N.touches[0].clientX - se, Rt = N.touches[0].clientY - ve, Qt = N.touches[1].clientX - se, _t = N.touches[1].clientY - ve, br = ae(nr, Rt, Qt, _t), Ir = br / ie, xa = 150, Hr = xa * xa, Ta = 1.5, Jn = Ta * Ta;
            if (Ir >= Jn || br >= Hr) {
          ...
          if (le && t.touchData.cxt) {
            ...
            var cr = t.touchData.start, nr = N.touches[0].clientX - se, Rt = N.touches[0].clientY - ve, Qt = N.touches[1].clientX - se, _t = N.touches[1].clientY - ve, Pu = ye(nr, Rt, Qt, _t), up = Pu / Z;
            if (Ee) {
              var lp = nr - X, fp = Rt - z, hp = Qt - re, cp = _t - W, vp = (lp + hp) / 2, dp = (fp + cp) / 2, rn = me.zoom(), Hi = rn * up, ei = me.pan(), Bu = ge[0] * rn + ei.x, Fu = ge[1] * rn + ei.y, gp = {
                x: -Hi / rn * (Bu - ei.x - vp) + Bu,
                y: -Hi / rn * (Fu - ei.y - dp) + Fu
              };
              if (cr && cr.active()) {
                var Gt = t.dragData.touchDragEles;
        ...
        checkPoint: function(e, r, a, n, i, s, o) {
          ...
          for (var h = this.generateBarrelBezierPts(n, i, s, o), c = function(x, I, C) {
            ...
            if (re <= x && x <= W && Z <= I && I <= ie) {
              var oe = Ff(B, F, R), ge = Nf(oe[0], oe[1], oe[2], x), se = ge.filter(function(ve) {
                return 0 <= ve && ve <= 1;
              });
              if (se.length > 0)
                return se[0];
    ...
    var zi = 1e3 / 60, vu = {
      ...
      function t(e) {
        ...
        he(this, t), this.idsByKey = new ur(), this.keyForId = new ur(), this.cachesByLvl = new ur(), this.lvls = [], this.getKey = e, this.doesEleInvalidateKey = r;
      }
      return A(t, [{
        key: "getIdsFor",
        value: function(r) {
    ...
    }(), du = 25, Kn = 50, Zn = -4, Gi = 3, pg = 7.99, yg = 8, mg = 1024, bg = 1024, Eg = 1024, wg = 0.2, xg = 0.8, Tg = 10, Cg = 0.15, Dg = 0.1, Sg = 0.9, Lg = 0.9, Ag = 100, Og = 1, ba = {
      dequeue: "dequeue",
      downscale: "downscale",
    ...
    Dt.reasons = ba, Dt.getTextureQueue = function(t) {
      ...
      if (!e || e.w === 0 || e.h === 0 || isNaN(e.w) || isNaN(e.h) || !t.visible() || t.removed() || !i.allowEdgeTxrCaching && t.isEdge() || !i.allowParentTxrCaching && t.isParent())
        return null;
      if (a == null && (a = Math.ceil(oi(o * r))), a < Zn)
        a = Zn;
      else if (o >= pg || a > Gi)
        return null;
      ...
      if (v && v.invalidated && (v.invalidated = !1, v.texture.invalidatedWidth -= v.width), v)
        return v;
      var d;
      if (f <= du ? d = du : f <= Kn ? d = Kn : d = Math.ceil(f / Kn) * Kn, f > Eg || h > bg)
        return null;
      ...
      }, b = n && n === ba.dequeue, E = n && n === ba.highQuality, M = n && n === ba.downscale, O, x = a + 1; x <= Gi; x++) {
        var I = l.get(t, x);
        if (I) {
          O = I;
          break;
    ...
    var Mg = 1, en = -4, Qn = 2, Ig = 3.99, Rg = 50, kg = 50, Pg = 0.15, Bg = 0.1, Fg = 0.9, zg = 0.9, Gg = 1, gu = 250, $g = 4e3 * 4e3, Vg = !0, pu = function(e) {
      var r = this, a = r.renderer = e, n = a.cy;
      r.layersByLevel = {}, r.firstGet = !0, r.lastInvalidationTime = dr() - 2 * gu, r.skipping = !1, r.eleTxrDeqs = n.collection(), r.scheduleElementRefinement = fn(function() {
    ...
    }, Mt = pu.prototype, yu = 0, _g = Math.pow(2, 53) - 1;
    ...
    hr.drawCachedElement = function(t, e, r, a, n, i) {
      ...
      if (!(c.w === 0 || c.h === 0 || !e.visible()) && (!a || li(c, a))) {
        ...
        s.drawElementUnderlay(t, e), s.drawCachedElementPortion(t, e, l, r, n, v, qg, Qg), (!d || !g) && s.drawCachedElementPortion(t, e, u, r, n, v, Wg, $i), d && !g && (s.drawCachedElementPortion(t, e, f, r, n, v, Kg, $i), s.drawCachedElementPortion(t, e, h, r, n, v, Zg, $i)), s.drawElementOverlay(t, e);
      }
    ...
    Ea.drawNode = function(t, e, r) {
      ...
      if (!(!k(h.x) || !k(h.y)) && !(i && !e.visible())) {
        ...
        if (v) {
          t.translate(h.x, h.y);
          var se = s.nodePathCache = s.nodePathCache || [], ve = ls(oe === "polygon" ? oe + "," + ge.join(",") : oe, "" + l, "" + o), we = se[ve];
    ...
    Wt.getPixelRatio = function() {
      ...
      if (!a && (f[s.DRAG] || r || se[s.DRAG])) {
        ...
        R(z, c && !ve ? "motionBlur" : void 0), ge ? s.drawCachedNodes(z, B.drag, o, ie) : s.drawCachedElements(z, B.drag, o, ie), s.debug && s.drawDebugPoints(z, B.drag), !r && !c && (f[s.DRAG] = !1);
      }
    ...
    function Ou(t) {
      ...
      e.onUpdateEleCalcs(function(ae, xe) {
        ge.invalidateElements(xe), se.invalidateElements(xe), ve.invalidateElements(xe), we.invalidateElements(xe), Te.invalidateElements(xe);
      ...
      ge.onDequeue(Ee), se.onDequeue(Ee), ve.onDequeue(Ee), we.onDequeue(Ee);
    }
    ...
    Za.prototype.extension = Yi, np.forEach(function(t) {
    ...
    return Yr.use = function(t) {
      ...
      return vs(t);
    }, Yr.version = op, Yr.stylesheet = Yr.Stylesheet = ku, Yr;
  });
})(Vu);
const _u = Vu.exports;
var Uu = { exports: {} }, qi = { exports: {} }, Wi = { exports: {} }, Gu;
function Tp() {
  return Gu || (Gu = 1, function(de, fe) {
    (function(he, Y) {
      de.exports = Y();
    })(Ca, function() {
      return function(Q) {
        ...
        return Y.m = Q, Y.c = he, Y.i = function(A) {
          return A;
        }, Y.d = function(A, T, w) {
        ...
        function(Q, he, Y) {
          ...
          V.prototype.getNodes = function() {
            ...
            for (var ne = T.MAX_VALUE, ue = -T.MAX_VALUE, j = T.MAX_VALUE, ee = -T.MAX_VALUE, H, te, S, $, k, q = this.nodes, ce = q.length, pe = 0; pe < ce; pe++) {
              var Ae = q[pe];
            ...
            for (var ne = T.MAX_VALUE, ue = -T.MAX_VALUE, j = T.MAX_VALUE, ee = -T.MAX_VALUE, H, te, S, $, k = J.length, q = 0; q < k; q++) {
              var ce = J[q];
              H = ce.getLeft(), te = ce.getRight(), S = ce.getTop(), $ = ce.getBottom(), ne > H && (ne = H), ue < te && (ue = te), j > S && (j = S), ee < $ && (ee = $);
            }
        ...
        function(Q, he, Y) {
          ...
          T.calcSeparationAmount = function(w, L, G, U) {
            ...
            var V = w.getX(), _ = w.getY(), J = w.getRight(), ne = w.getX(), ue = w.getBottom(), j = w.getRight(), ee = w.getWidthHalf(), H = w.getHeightHalf(), te = L.getX(), S = L.getY(), $ = L.getRight(), k = L.getX(), q = L.getBottom(), ce = L.getRight(), pe = L.getWidthHalf(), Ae = L.getHeightHalf(), Ne = !1, _e = !1;
            if (U === K) {
              if (P > D)
              ...
              if (-tt === Pe ? U > K ? (G[0] = ne, G[1] = ue, Ne = !0) : (G[0] = J, G[1] = _, Ne = !0) : tt === Pe && (U > K ? (G[0] = V, G[1] = _, Ne = !0) : (G[0] = j, G[1] = ue, Ne = !0)), -ct === Pe ? K > U ? (G[2] = k, G[3] = q, _e = !0) : (G[2] = $, G[3] = S, _e = !0) : ct === Pe && (K > U ? (G[2] = te, G[3] = S, _e = !0) : (G[2] = ce, G[3] = q, _e = !0)), Ne && _e)
                return !1;
            ...
            var P = w.x, K = w.y, D = L.x, V = L.y, _ = G.x, J = G.y, ne = U.x, ue = U.y, j = void 0, ee = void 0, H = void 0, te = void 0, S = void 0, $ = void 0, k = void 0, q = void 0, ce = void 0;
            return H = V - K, S = P - D, k = D * K - P * V, te = ue - J, $ = _ - ne, q = ne * J - _ * ue, ce = H * $ - te * S, ce === 0 ? null : (j = (S * q - $ * k) / ce, ee = (te * k - H * q) / ce, new A(j, ee));
    ...
    (function(he, Y) {
      ...
      return function(he) {
        ...
        function A(T) {
          ...
          return he[T].call(w.exports, w, w.exports, A), w.l = !0, w.exports;
        }
        return A.m = he, A.c = Y, A.i = function(T) {
          return T;
        }, A.d = function(T, w, L) {
        ...
        function(he, Y, A) {
          ...
          for (var L in T)
            w[L] = T[L];
          w.DEFAULT_USE_MULTI_LEVEL_SCALING = !1, w.DEFAULT_RADIAL_SEPARATION = T.DEFAULT_EDGE_LENGTH, w.DEFAULT_COMPONENT_SEPERATION = 60, w.TILE = !0, w.TILING_PADDING_VERTICAL = 10, w.TILING_PADDING_HORIZONTAL = 10, w.TREE_REDUCTION_ON_INCREMENTAL = !1, he.exports = w;
        },
        function(he, Y, A) {
        ...
        function(he, Y, A) {
          ...
          H.prototype.newGraphManager = function() {
            ...
            if (this.isTreeGrowing) {
              if (this.growTreeIterations % 10 == 0)
                if (this.prunedNodesAll.length > 0) {
                  ...
                  var S = new Set(this.getAllNodes()), $ = this.nodesWithGravity.filter(function(ce) {
                    return S.has(ce);
                  });
            ...
            var S = [], $, k = this.graphManager.getGraphs(), q = k.length, ce;
            for (ce = 0; ce < q; ce++)
              $ = k[ce], $.updateConnected(), $.isConnected || (S = S.concat($.getNodes()));
            return S;
            ...
            for (var $ = new V(0, 0), k = Math.ceil(Math.sqrt(S.length)), q = 0, ce = 0, pe = 0, Ae = new _(0, 0), Ne = 0; Ne < S.length; Ne++) {
              Ne % k == 0 && (pe = 0, ce = q, Ne != 0 && (ce += P.DEFAULT_COMPONENT_SEPERATION), q = 0);
              var _e = S[Ne], tt = J.findCenterOfTree(_e);
              $.x = pe, $.y = ce, Ae = H.radialLayout(_e, tt, $), Ae.y > q && (q = Math.floor(Ae.y)), pe = Math.floor(Ae.x + P.DEFAULT_COMPONENT_SEPERATION);
            }
            ...
            var ce = j.calculateBounds(S), pe = new ee();
          ...
          }, H.branchRadialLayout = function(S, $, k, q, ce, pe) {
            var Ae = (q - k + 1) / 2;
            Ae < 0 && (Ae += 180);
            ...
            for (var Et = Math.abs(q - k) / $e, kt = lt; Xe != $e; kt = ++kt % rt) {
              ...
              if (vt != $) {
                ...
                H.branchRadialLayout(vt, S, vr, qt, ce + pe, pe), Xe++;
              }
            }
          }, H.maxDiagonalInTree = function(S) {
            for (var $ = ne.MIN_VALUE, k = 0; k < S.length; k++) {
              var q = S[k], ce = q.getDiagonal();
              ce > $ && ($ = ce);
            }
            return $;
            ...
            for (var S = this.compoundOrder.length - 1; S >= 0; S--) {
              var $ = this.compoundOrder[S], k = $.id, q = $.paddingLeft, ce = $.paddingTop;
            ...
            Object.keys($).forEach(function(k) {
              var q = S.idToDummyNode[k], ce = q.paddingLeft, pe = q.paddingTop;
              S.adjustLocations($[k], q.rect.x, q.rect.y, ce, pe);
            });
          ...
          }, H.prototype.adjustLocations = function(S, $, k, q, ce) {
            $ += q, k += ce;
            ...
            this.tiledMemberPack = [], Object.keys(S).forEach(function(q) {
              var ce = $[q];
              k.tiledMemberPack[q] = k.tileNodes(S[q], ce.paddingLeft + ce.paddingRight), ce.rect.width = k.tiledMemberPack[q].width, ce.rect.height = k.tiledMemberPack[q].height;
            });
            ...
            if (q < 0)
              return !0;
            var ce = S.rowWidth[q];
            if (ce + S.horizontalPadding + $ <= S.width)
              return !0;
            var pe = 0;
            S.rowHeight[q] < k && q > 0 && (pe = k + S.verticalPadding - S.rowHeight[q]);
            var Ae;
            S.width - ce >= $ + S.horizontalPadding ? Ae = (S.height + pe) / (ce + $ + S.horizontalPadding) : Ae = (S.height + pe) / S.width, pe = k + S.verticalPadding;
            var Ne;
            ...
            var $ = this.getLongestRowIndex(S), k = S.rowWidth.length - 1, q = S.rows[$], ce = q[q.length - 1], pe = ce.width + S.horizontalPadding;
            if (S.width - S.rowWidth[k] > pe && $ != k) {
              q.splice(-1, 1), S.rows[k].push(ce), S.rowWidth[$] = S.rowWidth[$] - pe, S.rowWidth[k] = S.rowWidth[k] + pe, S.width = S.rowWidth[instance.getLongestRowIndex(S)];
              ...
              S.rowHeight[$] = Ae, S.rowHeight[k] < ce.height + S.verticalPadding && (S.rowHeight[k] = ce.height + S.verticalPadding);
            ...
            for (var $ = S.length, k = S[$ - 1], q, ce = 0; ce < k.length; ce++)
        ...
        function(he, Y, A) {
          var T = {};
          T.layoutBase = A(0), T.CoSEConstants = A(1), T.CoSEEdge = A(2), T.CoSEGraph = A(3), T.CoSEGraphManager = A(4), T.CoSELayout = A(6), T.CoSENode = A(5), he.exports = T;
        }
      ]);
    });
  }(qi)), qi.exports;
  ...
  (function(he, Y) {
    ...
    return function(he) {
      ...
      function(he, Y, A) {
        ...
        _.prototype.run = function() {
          ...
          for (var H = j.length, te = 0; te < H; te++) {
            ...
            if (S.outerWidth() != null && S.outerHeight() != null ? k = ue.add(new U(ee.graphManager, new P(S.position("x") - q.w / 2, S.position("y") - q.h / 2), new K(parseFloat(q.w), parseFloat(q.h)))) : k = ue.add(new U(this.graphManager)), k.id = S.data("id"), k.paddingLeft = parseInt(S.css("padding")), k.paddingTop = parseInt(S.css("padding")), k.paddingRight = parseInt(S.css("padding")), k.paddingBottom = parseInt(S.css("padding")), this.options.nodeDimensionsIncludeLabels && S.isParent()) {
              var ce = S.boundingBox({ includeLabels: !0, includeNodes: !1 }).w, pe = S.boundingBox({ includeLabels: !0, includeNodes: !1 }).h, Ae = S.css("text-halign");
        ...
        typeof cytoscape < "u" && ne(cytoscape), he.exports = ne;
      }
    ]);
  });
})(Uu);
const Dp = /* @__PURE__ */ yp(Uu.exports);
var Ki = function() {
  var de = function(ee, H, te, S) {
    for (te = te || {}, S = ee.length; S--; te[ee[S]] = H)
      ;
    return te;
  }, fe = [1, 4], Q = [1, 13], he = [1, 12], Y = [1, 15], A = [1, 16], T = [1, 20], w = [1, 19], L = [6, 7, 8], G = [1, 26], U = [1, 24], P = [1, 25], K = [6, 7, 11], D = [1, 6, 13, 15, 16, 19, 22], V = [1, 33], _ = [1, 34], J = [1, 6, 7, 11, 13, 15, 16, 19, 22], ne = {
    trace: function() {
    },
    yy: {},
    ...
    performAction: function(H, te, S, $, k, q, ce) {
      var pe = q.length - 1;
      switch (k) {
        case 6:
        case 7:
    ...
    table: [{ 3: 1, 4: 2, 5: 3, 6: [1, 5], 8: fe }, { 1: [3] }, { 1: [2, 1] }, { 4: 6, 6: [1, 7], 7: [1, 8], 8: fe }, { 6: Q, 7: [1, 10], 9: 9, 12: 11, 13: he, 14: 14, 15: Y, 16: A, 17: 17, 18: 18, 19: T, 22: w }, de(L, [2, 3]), { 1: [2, 2] }, de(L, [2, 4]), de(L, [2, 5]), { 1: [2, 6], 6: Q, 12: 21, 13: he, 14: 14, 15: Y, 16: A, 17: 17, 18: 18, 19: T, 22: w }, { 6: Q, 9: 22, 12: 11, 13: he, 14: 14, 15: Y, 16: A, 17: 17, 18: 18, 19: T, 22: w }, { 6: G, 7: U, 10: 23, 11: P }, de(K, [2, 22], { 17: 17, 18: 18, 14: 27, 15: [1, 28], 16: [1, 29], 19: T, 22: w }), de(K, [2, 18]), de(K, [2, 19]), de(K, [2, 20]), de(K, [2, 21]), de(K, [2, 23]), de(K, [2, 24]), de(K, [2, 26], { 19: [1, 30] }), { 20: [1, 31] }, { 6: G, 7: U, 10: 32, 11: P }, { 1: [2, 7], 6: Q, 12: 21, 13: he, 14: 14, 15: Y, 16: A, 17: 17, 18: 18, 19: T, 22: w }, de(D, [2, 14], { 7: V, 11: _ }), de(J, [2, 8]), de(J, [2, 9]), de(J, [2, 10]), de(K, [2, 15]), de(K, [2, 16]), de(K, [2, 17]), { 20: [1, 35] }, { 21: [1, 36] }, de(D, [2, 13], { 7: V, 11: _ }), de(J, [2, 11]), de(J, [2, 12]), { 21: [1, 37] }, de(K, [2, 25]), de(K, [2, 27])],
    ...
    parse: function(H) {
      var te = this, S = [0], $ = [], k = [null], q = [], ce = this.table, pe = "", Ae = 0, Ne = 0, _e = 2, tt = 1, ct = q.slice.call(arguments, 1), Pe = Object.create(this.lexer), $e = { yy: {} };
      ...
      for (var je, pt, Et, kt, vt = {}, vr, qt, un, Kr; ; ) {
        if (pt = S[S.length - 1], this.defaultActions[pt] ? Et = this.defaultActions[pt] : ((je === null || typeof je > "u") && (je = nt()), Et = ce[pt] && ce[pt][je]), typeof Et > "u" || !Et.length || !Et[0]) {
          var Da = "";
          Kr = [];
          for (vr in ce[pt])
        ...
        switch (Et[0]) {
          ...
          case 2:
            if (qt = this.productions_[Et[1]][1], vt.$ = k[k.length - qt], vt._$ = {
              ...
              return kt;
            qt && (S = S.slice(0, -1 * qt * 2), k = k.slice(0, -1 * qt), q = q.slice(0, -1 * qt)), S.push(this.productions_[Et[1]][0]), k.push(vt.$), q.push(vt._$), un = ce[S[S.length - 2]][S[S.length - 1]], S.push(un);
            break;
          case 3:
            return !0;
        }
...
const Lp = () => {
  ...
  for (let fe = Jt.length - 1; fe >= 0; fe--)
    if (Jt[fe].level < de)
      return Jt[fe];
  return null;
}, Op = () => Jt.length > 0 ? Jt[0] : null, Np = (de, fe, Q, he) => {
  qr.info("addNode", de, fe, Q, he);
  const Y = sn(), A = {
    id: Yu++,
    nodeId: on(fe),
    level: de,
  ...
  switch (qr.debug("In get type", de, fe), de) {
    case "[":
      return yt.RECT;
    case "(":
  ...
  de && de.icon && (fe.icon = on(de.icon)), de && de.class && (fe.class = on(de.class));
}, Wr = (de) => {
  switch (de) {
    case yt.DEFAULT:
      return "no-border";
...
const Rp = (de) => {
  Xu = de;
}, kp = () => qr, Pp = (de) => Jt[de], Qi = (de) => Zi[de], Bp = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  addNode: Np,
  clear: Lp,
  decorateNode: Ip,
  ...
  setErrorHandler: Rp,
  type2Str: Wr
}, Symbol.toStringTag, { value: "Module" })), qu = 12;
function Fp(de, fe) {
  de.each(function() {
    var Q = nn(this), he = Q.text().split(/(\s+|<br>)/).reverse(), Y, A = [], T = 1.1, w = Q.attr("y"), L = parseFloat(Q.attr("dy")), G = Q.text(null).append("tspan").attr("x", 0).attr("y", w).attr("dy", L + "em");
    for (let U = 0; U < he.length; U++)
      Y = he[he.length - 1 - U], A.push(Y), G.text(A.join(" ").trim()), (G.node().getComputedTextLength() > fe || Y === "<br>") && (A.pop(), G.text(A.join(" ").trim()), Y === "<br>" ? A = [""] : A = [Y], G = Q.append("tspan").attr("x", 0).attr("y", w).attr("dy", T + "em").text(Y));
  });
}
const zp = function(de, fe, Q) {
  de.append("path").attr("id", "node-" + fe.id).attr("class", "node-bkg node-" + Wr(fe.type)).attr(
    "d",
    `M0 ${fe.height - 5} v${-fe.height + 2 * 5} q0,-5 5,-5 h${fe.width - 2 * 5} q5,0 5,5 v${fe.height - 5} H0 Z`
  ), de.append("line").attr("class", "node-line-" + Q).attr("x1", 0).attr("y1", fe.height).attr("x2", fe.width).attr("y2", fe.height);
}, Gp = function(de, fe) {
  de.append("rect").attr("id", "node-" + fe.id).attr("class", "node-bkg node-" + Wr(fe.type)).attr("height", fe.height).attr("width", fe.width);
}, $p = function(de, fe) {
  const Q = fe.width, he = fe.height, Y = 0.15 * Q, A = 0.25 * Q, T = 0.35 * Q, w = 0.2 * Q;
  de.append("path").attr("id", "node-" + fe.id).attr("class", "node-bkg node-" + Wr(fe.type)).attr(
    "d",
    `M0 0 a${Y},${Y} 0 0,1 ${Q * 0.25},${-1 * Q * 0.1}
      ...
      a${Y},${Y} 1 0,1 ${Q * 0.15},${1 * he * 0.35}
      a${w},${w} 1 0,1 ${-1 * Q * 0.15},${1 * he * 0.65}

      a${A},${Y} 1 0,1 ${-1 * Q * 0.25},${Q * 0.15}
      a${T},${T} 1 0,1 ${-1 * Q * 0.5},${0}
      a${Y},${Y} 1 0,1 ${-1 * Q * 0.25},${-1 * Q * 0.15}

      a${Y},${Y} 1 0,1 ${-1 * Q * 0.1},${-1 * he * 0.35}
      a${w},${w} 1 0,1 ${Q * 0.1},${-1 * he * 0.65}

    H0 V0 Z`
  );
}, Vp = function(de, fe) {
  const Q = fe.width, he = fe.height, Y = 0.15 * Q;
  de.append("path").attr("id", "node-" + fe.id).attr("class", "node-bkg node-" + Wr(fe.type)).attr(
    "d",
    `M0 0 a${Y},${Y} 1 0,0 ${Q * 0.25},${-1 * he * 0.1}
      a${Y},${Y} 1 0,0 ${Q * 0.25},${0}
      a${Y},${Y} 1 0,0 ${Q * 0.25},${0}
      a${Y},${Y} 1 0,0 ${Q * 0.25},${1 * he * 0.1}

      a${Y},${Y} 1 0,0 ${Q * 0.15},${1 * he * 0.33}
      a${Y * 0.8},${Y * 0.8} 1 0,0 ${0},${1 * he * 0.34}
      a${Y},${Y} 1 0,0 ${-1 * Q * 0.15},${1 * he * 0.33}

      a${Y},${Y} 1 0,0 ${-1 * Q * 0.25},${he * 0.15}
      a${Y},${Y} 1 0,0 ${-1 * Q * 0.25},${0}
      a${Y},${Y} 1 0,0 ${-1 * Q * 0.25},${0}
      a${Y},${Y} 1 0,0 ${-1 * Q * 0.25},${-1 * he * 0.15}

      a${Y},${Y} 1 0,0 ${-1 * Q * 0.1},${-1 * he * 0.33}
      a${Y * 0.8},${Y * 0.8} 1 0,0 ${0},${-1 * he * 0.34}
      a${Y},${Y} 1 0,0 ${Q * 0.1},${-1 * he * 0.33}

    H0 V0 Z`
  );
}, _p = function(de, fe) {
  de.append("circle").attr("id", "node-" + fe.id).attr("class", "node-bkg node-" + Wr(fe.type)).attr("r", fe.width / 2);
};
function Up(de, fe, Q, he, Y) {
  return de.insert("polygon", ":first-child").attr(
    "points",
    he.map(function(A) {
      return A.x + "," + A.y;
    }).join(" ")
  ).attr("transform", "translate(" + (Y.width - fe) / 2 + ", " + Q + ")");
}
const Yp = function(de, fe) {
  const Q = fe.height, Y = Q / 4, A = fe.width - fe.padding + 2 * Y, T = [
    { x: Y, y: 0 },
    { x: A - Y, y: 0 },
    { x: A, y: -Q / 2 },
    { x: A - Y, y: -Q },
  ...
  de.append("rect").attr("id", "node-" + fe.id).attr("class", "node-bkg node-" + Wr(fe.type)).attr("height", fe.height).attr("rx", fe.padding).attr("ry", fe.padding).attr("width", fe.width);
}, Xp = function(de, fe, Q, he) {
  const Y = Q % (qu - 1), A = de.append("g");
  fe.section = Y;
  let T = "section-" + Y;
  Y < 0 && (T += " section-root"), A.attr("class", (fe.class ? fe.class + " " : "") + "mindmap-node " + T);
  const w = A.append("g"), L = A.append("g"), U = L.append("text").text(fe.descr).attr("dy", "1em").attr("alignment-baseline", "middle").attr("dominant-baseline", "middle").attr("text-anchor", "middle").call(Fp, fe.width).node().getBBox(), P = he.fontSize.replace ? he.fontSize.replace("px", "") : he.fontSize;
  if (fe.height = U.height + P * 1.1 * 0.5 + fe.padding, fe.width = U.width + 2 * fe.padding, fe.icon)
    if (fe.type === yt.CIRCLE)
      fe.height += 50, fe.width += 50, A.append("foreignObject").attr("height", "50px").attr("width", fe.width).attr("style", "text-align: center;").append("div").attr("class", "icon-container").append("i").attr("class", "node-icon-" + Y + " " + fe.icon), L.attr(
        "transform",
      ...
      fe.width += 50;
      const K = fe.height;
      fe.height = Math.max(K, 60);
      const D = Math.abs(fe.height - K);
      A.append("foreignObject").attr("width", "60px").attr("height", fe.height).attr("style", "text-align: center;margin-top:" + D / 2 + "px;").append("div").attr("class", "icon-container").append("i").attr("class", "node-icon-" + Y + " " + fe.icon), L.attr(
        "transform",
        "translate(" + (25 + fe.width / 2) + ", " + (D / 2 + fe.padding / 2) + ")"
      );
    }
  else
    L.attr("transform", "translate(" + fe.width / 2 + ", " + fe.padding / 2 + ")");
  switch (fe.type) {
    case yt.DEFAULT:
      zp(w, fe, Y);
      break;
    ...
    case yt.RECT:
      ...
      break;
    case yt.CIRCLE:
      w.attr("transform", "translate(" + fe.width / 2 + ", " + +fe.height / 2 + ")"), _p(w, fe);
      break;
    case yt.CLOUD:
      $p(w, fe);
      break;
  ...
  return Hu(fe.id, A), fe.height;
}, qp = function(fe, Q, he, Y, A) {
  const T = A % (qu - 1), w = he.x + he.width / 2, L = he.y + he.height / 2, G = Q.x + Q.width / 2, U = Q.y + Q.height / 2, P = G > w ? w + Math.abs(w - G) / 2 : w - Math.abs(w - G) / 2, K = U > L ? L + Math.abs(L - U) / 2 : L - Math.abs(L - U) / 2, D = G > w ? Math.abs(w - P) / 2 + w : -Math.abs(w - P) / 2 + w, V = U > L ? Math.abs(L - K) / 2 + L : -Math.abs(L - K) / 2 + L;
  fe.append("path").attr(
    "d",
    he.direction === "TB" || he.direction === "BT" ? `M${w},${L} Q${w},${V} ${P},${K} T${G},${U}` : `M${w},${L} Q${D},${L} ${P},${K} T${G},${U}`
  ).attr("class", "edge section-edge-" + T + " edge-depth-" + Y);
}, Wp = function(de) {
  const fe = Qi(de.id), Q = de.x || 0, he = de.y || 0;
  fe.attr("transform", "translate(" + Q + "," + he + ")");
}, Wu = { drawNode: Xp, positionNode: Wp, drawEdge: qp };
_u.use(Dp);
function Ku(de, fe, Q, he) {
  Wu.drawNode(de, fe, Q, he), fe.children && fe.children.forEach((Y, A) => {
    Ku(de, Y, Q < 0 ? A : Q, he);
  });
}
function Kp(de, fe) {
  fe.edges().map((Q, he) => {
    ...
    if (Q[0]._private.bodyBounds) {
      ...
      qr.trace("Edge: ", he, Y), de.insert("path").attr(
        "d",
...
function Zu(de, fe, Q, he) {
  ...
  }), de.children && de.children.forEach((Y) => {
    Zu(Y, fe, Q, he + 1), fe.add({
      group: "edges",
      data: {
        id: `${de.id}_${Y.id}`,
        source: de.id,
...
function Zp(de, fe) {
  return new Promise((Q) => {
    const he = nn("body").append("div").attr("id", "cy").attr("style", "display:none"), Y = _u({
    ...
    he.remove(), Zu(de, Y, fe, 0), Y.nodes().forEach(function(A) {
      A.layoutDimensions = () => {
        const T = A.data();
...
function Qp(de) {
  de.nodes().map((fe, Q) => {
    const he = fe.data();
    he.x = fe.position().x, he.y = fe.position().y, Wu.positionNode(he);
    const Y = Qi(he.nodeId);
    qr.info("Id:", Q, "Position: (", fe.position().x, ", ", fe.position().y, ")", he), Y.attr(
      "transform",
      `translate(${fe.position().x - he.width / 2}, ${fe.position().y - he.height / 2})`
    ), Y.attr("attr", `apa-${Q})`);
  });
}
const Jp = async (de, fe, Q, he) => {
  const Y = sn();
  he.db.clear(), he.parser.parse(de), qr.debug(`Renering info diagram
` + de);
  const A = sn().securityLevel;
  let T;
  A === "sandbox" && (T = nn("#i" + fe));
  const L = (A === "sandbox" ? nn(T.nodes()[0].contentDocument.body) : nn("body")).select("#" + fe);
  L.append("g");
  const G = he.db.getMindmap(), U = L.append("g");
  U.attr("class", "mindmap-edges");
  const P = L.append("g");
  P.attr("class", "mindmap-nodes"), Ku(P, G, -1, Y);
  const K = await Zp(G, Y);
  Kp(U, K), Qp(K), bp(void 0, L, Y.mindmap.padding, Y.mindmap.useMaxWidth);
}, jp = {
  draw: Jp
}, ey = (de) => {
  let fe = "";
  for (let Q = 0; Q < de.THEME_COLOR_LIMIT; Q++)
    de["lineColor" + Q] = de["lineColor" + Q] || de["cScaleInv" + Q], xp(de["lineColor" + Q]) ? de["lineColor" + Q] = Ep(de["lineColor" + Q], 20) : de["lineColor" + Q] = wp(de["lineColor" + Q], 20);
  for (let Q = 0; Q < de.THEME_COLOR_LIMIT; Q++) {
    const he = "" + (17 - 3 * Q);
    fe += `
    ...
    .section-${Q - 1} text {
     fill: ${de["cScaleLabel" + Q]};
    }
    .node-icon-${Q - 1} {
      font-size: 40px;
      color: ${de["cScaleLabel" + Q]};
    }
    .section-edge-${Q - 1}{
      stroke: ${de["cScale" + Q]};
    }
